...
**Generator:** `scripts/history-educator/history_visuals.py` → `history_balloon_kml(phases, title)`.
...
- `scripts/history-educator/history_visuals.py` — parchment balloon + KML layer generators (history_balloon_kml, territory_polygon_kml, advance_arrow_kml, battle_marker_kml, siege_ring_kml, capital_pin_kml, style_defs, master_kml_document)
