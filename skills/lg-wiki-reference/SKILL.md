...
- `references/wiki-search-navigation.md` — How to navigate the wiki SPA: search-based navigation (reliable), direct URL limitations, fallback JS extraction
- `references/balloon-deployment-attempt.md` — RESOLVED record of the July 2026 balloon deployment: CDATA fails on VM, escaped HTML works, rightmost = slave_2.kml on 3-screen rig
